...
function findWasmBinary() {
  return locateFile("text_wasm_internal.wasm");
}
...
function assignWasmExports(wasmExports) {
  ...
  _malloc = Module["_malloc"] = wasmExports["Tb"];
  _registerModelResourcesGraphService = Module["_registerModelResourcesGraphService"] = wasmExports["Ub"];
  _bindTextureToStream = Module["_bindTextureToStream"] = wasmExports["Vb"];
  _addBoundTextureToStream = Module["_addBoundTextureToStream"] = wasmExports["Wb"];
  _addDoubleToInputStream = Module["_addDoubleToInputStream"] = wasmExports["Xb"];
  _addFloatToInputStream = Module["_addFloatToInputStream"] = wasmExports["Yb"];
  _addBoolToInputStream = Module["_addBoolToInputStream"] = wasmExports["Zb"];
  _addIntToInputStream = Module["_addIntToInputStream"] = wasmExports["_b"];
  _addUintToInputStream = Module["_addUintToInputStream"] = wasmExports["$b"];
  _addStringToInputStream = Module["_addStringToInputStream"] = wasmExports["ac"];
  _addRawDataSpanToInputStream = Module["_addRawDataSpanToInputStream"] = wasmExports["bc"];
  _allocateBoolVector = Module["_allocateBoolVector"] = wasmExports["cc"];
  _allocateFloatVector = Module["_allocateFloatVector"] = wasmExports["dc"];
  _allocateDoubleVector = Module["_allocateDoubleVector"] = wasmExports["ec"];
  _allocateIntVector = Module["_allocateIntVector"] = wasmExports["fc"];
  _allocateUintVector = Module["_allocateUintVector"] = wasmExports["gc"];
  _allocateStringVector = Module["_allocateStringVector"] = wasmExports["hc"];
  _addBoolVectorEntry = Module["_addBoolVectorEntry"] = wasmExports["ic"];
  _addFloatVectorEntry = Module["_addFloatVectorEntry"] = wasmExports["jc"];
  _addDoubleVectorEntry = Module["_addDoubleVectorEntry"] = wasmExports["kc"];
  _addIntVectorEntry = Module["_addIntVectorEntry"] = wasmExports["lc"];
  _addUintVectorEntry = Module["_addUintVectorEntry"] = wasmExports["mc"];
  _addStringVectorEntry = Module["_addStringVectorEntry"] = wasmExports["nc"];
  _addBoolVectorToInputStream = Module["_addBoolVectorToInputStream"] = wasmExports["oc"];
  _addFloatVectorToInputStream = Module["_addFloatVectorToInputStream"] = wasmExports["pc"];
  _addDoubleVectorToInputStream = Module["_addDoubleVectorToInputStream"] = wasmExports["qc"];
  _addIntVectorToInputStream = Module["_addIntVectorToInputStream"] = wasmExports["rc"];
  _addUintVectorToInputStream = Module["_addUintVectorToInputStream"] = wasmExports["sc"];
  _addStringVectorToInputStream = Module["_addStringVectorToInputStream"] = wasmExports["tc"];
  _addFlatHashMapToInputStream = Module["_addFlatHashMapToInputStream"] = wasmExports["uc"];
  _addProtoToInputStream = Module["_addProtoToInputStream"] = wasmExports["vc"];
  _addEmptyPacketToInputStream = Module["_addEmptyPacketToInputStream"] = wasmExports["wc"];
  _addBoolToInputSidePacket = Module["_addBoolToInputSidePacket"] = wasmExports["xc"];
  _addDoubleToInputSidePacket = Module["_addDoubleToInputSidePacket"] = wasmExports["yc"];
  _addFloatToInputSidePacket = Module["_addFloatToInputSidePacket"] = wasmExports["zc"];
  _addIntToInputSidePacket = Module["_addIntToInputSidePacket"] = wasmExports["Ac"];
  _addUintToInputSidePacket = Module["_addUintToInputSidePacket"] = wasmExports["Bc"];
  _addStringToInputSidePacket = Module["_addStringToInputSidePacket"] = wasmExports["Cc"];
  _addRawDataSpanToInputSidePacket = Module["_addRawDataSpanToInputSidePacket"] = wasmExports["Dc"];
  _addProtoToInputSidePacket = Module["_addProtoToInputSidePacket"] = wasmExports["Ec"];
  _addBoolVectorToInputSidePacket = Module["_addBoolVectorToInputSidePacket"] = wasmExports["Fc"];
  _addDoubleVectorToInputSidePacket = Module["_addDoubleVectorToInputSidePacket"] = wasmExports["Gc"];
  _addFloatVectorToInputSidePacket = Module["_addFloatVectorToInputSidePacket"] = wasmExports["Hc"];
  _addIntVectorToInputSidePacket = Module["_addIntVectorToInputSidePacket"] = wasmExports["Ic"];
  _addUintVectorToInputSidePacket = Module["_addUintVectorToInputSidePacket"] = wasmExports["Jc"];
  _addStringVectorToInputSidePacket = Module["_addStringVectorToInputSidePacket"] = wasmExports["Kc"];
  _attachBoolListener = Module["_attachBoolListener"] = wasmExports["Lc"];
  _attachBoolVectorListener = Module["_attachBoolVectorListener"] = wasmExports["Mc"];
  _attachDoubleListener = Module["_attachDoubleListener"] = wasmExports["Nc"];
  _attachDoubleVectorListener = Module["_attachDoubleVectorListener"] = wasmExports["Oc"];
  _attachFloatListener = Module["_attachFloatListener"] = wasmExports["Pc"];
  _attachFloatVectorListener = Module["_attachFloatVectorListener"] = wasmExports["Qc"];
  _attachIntListener = Module["_attachIntListener"] = wasmExports["Rc"];
  _attachIntVectorListener = Module["_attachIntVectorListener"] = wasmExports["Sc"];
  _attachUintListener = Module["_attachUintListener"] = wasmExports["Tc"];
  _attachUintVectorListener = Module["_attachUintVectorListener"] = wasmExports["Uc"];
  _attachStringListener = Module["_attachStringListener"] = wasmExports["Vc"];
  _attachStringVectorListener = Module["_attachStringVectorListener"] = wasmExports["Wc"];
  _attachProtoListener = Module["_attachProtoListener"] = wasmExports["Xc"];
  _attachProtoVectorListener = Module["_attachProtoVectorListener"] = wasmExports["Yc"];
  _getGraphConfig = Module["_getGraphConfig"] = wasmExports["Zc"];
  _emwgpuCreateBindGroup = wasmExports["_c"];
  _emwgpuCreateBindGroupLayout = wasmExports["$c"];
  _emwgpuCreateCommandBuffer = wasmExports["ad"];
  _emwgpuCreateCommandEncoder = wasmExports["bd"];
  _emwgpuCreateComputePassEncoder = wasmExports["cd"];
  _emwgpuCreateComputePipeline = wasmExports["dd"];
  _emwgpuCreateExternalTexture = wasmExports["ed"];
  _emwgpuCreatePipelineLayout = wasmExports["fd"];
  _emwgpuCreateQuerySet = wasmExports["gd"];
  _emwgpuCreateRenderBundle = wasmExports["hd"];
  _emwgpuCreateRenderBundleEncoder = wasmExports["id"];
  _emwgpuCreateRenderPassEncoder = wasmExports["jd"];
  _emwgpuCreateRenderPipeline = wasmExports["kd"];
  _emwgpuCreateSampler = wasmExports["ld"];
  _emwgpuCreateSurface = wasmExports["md"];
  _emwgpuCreateTexture = wasmExports["nd"];
  _emwgpuCreateTextureView = wasmExports["od"];
  _emwgpuCreateAdapter = wasmExports["pd"];
  _emwgpuImportBuffer = wasmExports["qd"];
  _emwgpuCreateDevice = wasmExports["rd"];
  _emwgpuCreateQueue = wasmExports["sd"];
  _emwgpuCreateShaderModule = wasmExports["td"];
  _clearSubgraphs = Module["_clearSubgraphs"] = wasmExports["ud"];
  _pushBinarySubgraph = Module["_pushBinarySubgraph"] = wasmExports["vd"];
  _pushTextSubgraph = Module["_pushTextSubgraph"] = wasmExports["wd"];
  _changeBinaryGraph = Module["_changeBinaryGraph"] = wasmExports["xd"];
  _changeTextGraph = Module["_changeTextGraph"] = wasmExports["yd"];
  _processGl = Module["_processGl"] = wasmExports["zd"];
  _process = Module["_process"] = wasmExports["Ad"];
  _bindTextureToCanvas = Module["_bindTextureToCanvas"] = wasmExports["Bd"];
  _requestShaderRefreshOnGraphChange = Module["_requestShaderRefreshOnGraphChange"] = wasmExports["Cd"];
  ...
  memory = wasmMemory = wasmExports["hb"];
  _kVersionStampBuildChangelistStr = Module["_kVersionStampBuildChangelistStr"] = wasmExports["jb"].value;
  _kVersionStampCitcSnapshotStr = Module["_kVersionStampCitcSnapshotStr"] = wasmExports["kb"].value;
  _kVersionStampCitcWorkspaceIdStr = Module["_kVersionStampCitcWorkspaceIdStr"] = wasmExports["lb"].value;
  _kVersionStampSourceUriStr = Module["_kVersionStampSourceUriStr"] = wasmExports["mb"].value;
  _kVersionStampBuildClientStr = Module["_kVersionStampBuildClientStr"] = wasmExports["nb"].value;
  _kVersionStampBuildClientMintStatusStr = Module["_kVersionStampBuildClientMintStatusStr"] = wasmExports["ob"].value;
  _kVersionStampBuildCompilerStr = Module["_kVersionStampBuildCompilerStr"] = wasmExports["pb"].value;
  _kVersionStampBuildDateTimePstStr = Module["_kVersionStampBuildDateTimePstStr"] = wasmExports["qb"].value;
  _kVersionStampBuildDepotPathStr = Module["_kVersionStampBuildDepotPathStr"] = wasmExports["rb"].value;
  _kVersionStampBuildIdStr = Module["_kVersionStampBuildIdStr"] = wasmExports["sb"].value;
  _kVersionStampBuildInfoStr = Module["_kVersionStampBuildInfoStr"] = wasmExports["tb"].value;
  _kVersionStampBuildLabelStr = Module["_kVersionStampBuildLabelStr"] = wasmExports["ub"].value;
  _kVersionStampBuildTargetStr = Module["_kVersionStampBuildTargetStr"] = wasmExports["vb"].value;
  _kVersionStampBuildTimestampStr = Module["_kVersionStampBuildTimestampStr"] = wasmExports["wb"].value;
  _kVersionStampBuildToolStr = Module["_kVersionStampBuildToolStr"] = wasmExports["xb"].value;
  _kVersionStampG3BuildTargetStr = Module["_kVersionStampG3BuildTargetStr"] = wasmExports["yb"].value;
  _kVersionStampVerifiableStr = Module["_kVersionStampVerifiableStr"] = wasmExports["zb"].value;
  _kVersionStampBuildFdoTypeStr = Module["_kVersionStampBuildFdoTypeStr"] = wasmExports["Ab"].value;
  _kVersionStampBuildBaselineChangelistStr = Module["_kVersionStampBuildBaselineChangelistStr"] = wasmExports["Bb"].value;
  _kVersionStampBuildLtoTypeStr = Module["_kVersionStampBuildLtoTypeStr"] = wasmExports["Cb"].value;
  _kVersionStampBuildPropellerTypeStr = Module["_kVersionStampBuildPropellerTypeStr"] = wasmExports["Db"].value;
  _kVersionStampBuildPghoTypeStr = Module["_kVersionStampBuildPghoTypeStr"] = wasmExports["Eb"].value;
  _kVersionStampBuildUsernameStr = Module["_kVersionStampBuildUsernameStr"] = wasmExports["Fb"].value;
  _kVersionStampBuildHostnameStr = Module["_kVersionStampBuildHostnameStr"] = wasmExports["Gb"].value;
  _kVersionStampBuildDirectoryStr = Module["_kVersionStampBuildDirectoryStr"] = wasmExports["Hb"].value;
  _kVersionStampBuildChangelistInt = Module["_kVersionStampBuildChangelistInt"] = wasmExports["Ib"].value;
  _kVersionStampCitcSnapshotInt = Module["_kVersionStampCitcSnapshotInt"] = wasmExports["Jb"].value;
  _kVersionStampBuildClientMintStatusInt = Module["_kVersionStampBuildClientMintStatusInt"] = wasmExports["Kb"].value;
  _kVersionStampBuildTimestampInt = Module["_kVersionStampBuildTimestampInt"] = wasmExports["Lb"].value;
  _kVersionStampVerifiableInt = Module["_kVersionStampVerifiableInt"] = wasmExports["Mb"].value;
  _kVersionStampBuildCoverageEnabledInt = Module["_kVersionStampBuildCoverageEnabledInt"] = wasmExports["Nb"].value;
  _kVersionStampBuildBaselineChangelistInt = Module["_kVersionStampBuildBaselineChangelistInt"] = wasmExports["Ob"].value;
...
var wasmImports = {
  ...
  /** @export */ cb: JsOnSimpleListenerInt,
  /** @export */ bb: JsOnSimpleListenerString,
  /** @export */ ab: JsOnSimpleListenerUint,
  /** @export */ g: JsOnVectorFinishedListener,
  /** @export */ $a: JsOnVectorListenerBool,
  /** @export */ _a: JsOnVectorListenerDouble,
  /** @export */ Za: JsOnVectorListenerFloat,
  /** @export */ Ya: JsOnVectorListenerInt,
  /** @export */ Xa: JsOnVectorListenerProto,
  /** @export */ Wa: JsOnVectorListenerString,
  ...
  /** @export */ ya: _emscripten_webgl_get_context_attributes,
  /** @export */ i: _emscripten_webgl_get_current_context,
  /** @export */ xa: _emscripten_webgl_make_context_current,
  /** @export */ wa: _emwgpuBufferDestroy,
  /** @export */ c: _emwgpuDelete,
  /** @export */ va: _emwgpuDeviceCreateBuffer,
