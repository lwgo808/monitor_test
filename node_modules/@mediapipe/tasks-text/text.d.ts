...
export declare class LanguageDetector extends TaskRunner {
     ...
     */
    static createFromModelBuffer(wasmFileset: WasmFileset, modelAssetBuffer: Uint8Array | ReadableStreamDefaultReader): Promise<LanguageDetector>;
    /**
     * Initializes the Wasm runtime and creates a new language detector based on
...
export declare class TextClassifier extends TaskRunner {
     ...
     *    representation of the model.
     */
    static createFromModelBuffer(wasmFileset: WasmFileset, modelAssetBuffer: Uint8Array | ReadableStreamDefaultReader): Promise<TextClassifier>;
    /**
     * Initializes the Wasm runtime and creates a new text classifier based on the
...
export declare class TextEmbedder extends TaskRunner {
     ...
     *    representation of the model.
     */
    static createFromModelBuffer(wasmFileset: WasmFileset, modelAssetBuffer: Uint8Array | ReadableStreamDefaultReader): Promise<TextEmbedder>;
    /**
     * Initializes the Wasm runtime and creates a new text embedder based on the
     * path to the model asset.
     * @export
