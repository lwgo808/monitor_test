...
function findWasmBinary() {
  return locateFile("genai_wasm_nosimd_internal.wasm");
}
...
var ASM_CONSTS = {
  2084684: () => !!Module["preinitializedWebGPUDevice"],
  2084735: () => {
  ...
  2084918: () => !!Module["preinitializedWebGPUDevice"],
  2084969: () => {
...
var _free, _CreateLlmInferenceEngineConverted, _DeleteLlmInferenceEngine, _MakeSessionForPredict, _AddTextQueryChunk, _AddImageQueryChunk, _AddAudioQueryChunk, _malloc, _PredictSession, _FreeSession, _GetSizeInTokens, _wgpuDeviceAddRef, _registerModelResourcesGraphService, _bindTextureToStream, _addBoundTextureToStream, _addDoubleToInputStream, _addFloatToInputStream, _addBoolToInputStream, _addIntToInputStream, _addUintToInputStream, _addStringToInputStream, _addRawDataSpanToInputStream, _allocateBoolVector, _allocateFloatVector, _allocateDoubleVector, _allocateIntVector, _allocateUintVector, _allocateStringVector, _addBoolVectorEntry, _addFloatVectorEntry, _addDoubleVectorEntry, _addIntVectorEntry, _addUintVectorEntry, _addStringVectorEntry, _addBoolVectorToInputStream, _addFloatVectorToInputStream, _addDoubleVectorToInputStream, _addIntVectorToInputStream, _addUintVectorToInputStream, _addStringVectorToInputStream, _addFlatHashMapToInputStream, _addProtoToInputStream, _addEmptyPacketToInputStream, _addBoolToInputSidePacket, _addDoubleToInputSidePacket, _addFloatToInputSidePacket, _addIntToInputSidePacket, _addUintToInputSidePacket, _addStringToInputSidePacket, _addRawDataSpanToInputSidePacket, _addProtoToInputSidePacket, _addBoolVectorToInputSidePacket, _addDoubleVectorToInputSidePacket, _addFloatVectorToInputSidePacket, _addIntVectorToInputSidePacket, _addUintVectorToInputSidePacket, _addStringVectorToInputSidePacket, _attachBoolListener, _attachBoolVectorListener, _attachDoubleListener, _attachDoubleVectorListener, _attachFloatListener, _attachFloatVectorListener, _attachIntListener, _attachIntVectorListener, _attachUintListener, _attachUintVectorListener, _attachStringListener, _attachStringVectorListener, _attachProtoListener, _attachProtoVectorListener, _getGraphConfig, ___getTypeName, _emwgpuCreateBindGroup, _emwgpuCreateBindGroupLayout, _emwgpuCreateCommandBuffer, _emwgpuCreateCommandEncoder, _emwgpuCreateComputePassEncoder, _emwgpuCreateComputePipeline, _emwgpuCreateExternalTexture, _emwgpuCreatePipelineLayout, _emwgpuCreateQuerySet, _emwgpuCreateRenderBundle, _emwgpuCreateRenderBundleEncoder, _emwgpuCreateRenderPassEncoder, _emwgpuCreateRenderPipeline, _emwgpuCreateSampler, _emwgpuCreateSurface, _emwgpuCreateTexture, _emwgpuCreateTextureView, _emwgpuCreateAdapter, _emwgpuImportBuffer, _emwgpuCreateDevice, _emwgpuCreateQueue, _emwgpuCreateShaderModule, _emwgpuOnCreateComputePipelineCompleted, _emwgpuOnWorkDoneCompleted, _clearSubgraphs, _pushBinarySubgraph, _pushTextSubgraph, _changeBinaryGraph, _changeTextGraph, _processGl, _process, _bindTextureToCanvas, _requestShaderRefreshOnGraphChange, _waitUntilIdle, _closeGraph, _setAutoRenderToScreen, _emscripten_builtin_memalign, _memalign, __emscripten_tempret_set, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, dynCall_vii, dynCall_viiiiiii, dynCall_viiiiii, dynCall_v, dynCall_ii, dynCall_vi, dynCall_iiiii, dynCall_iii, dynCall_viii, dynCall_iiii, dynCall_iiiijij, dynCall_i, dynCall_ji, dynCall_viiii, dynCall_viiiii, dynCall_jii, dynCall_ff, dynCall_did, dynCall_iiiiiii, dynCall_iiiiii, dynCall_iiiiiiiiiii, dynCall_iiiiiiiiiiii, dynCall_iiiiiiiii, dynCall_iiiiiiii, dynCall_iiiiiiiiii, dynCall_iij, dynCall_viijj, dynCall_vijiii, dynCall_viiiiiiii, dynCall_iiiif, dynCall_viiiiiiiiiiiiiii, dynCall_viff, dynCall_viiffii, dynCall_viiffi, dynCall_viiiiiiiiii, dynCall_fi, dynCall_viiffff, dynCall_viiiiij, dynCall_vij, dynCall_viiiiiffii, dynCall_vif, dynCall_ddd, dynCall_dddd, dynCall_idd, dynCall_di, dynCall_jiiiijiiiii, dynCall_viiij, dynCall_viid, dynCall_vidd, dynCall_vifd, dynCall_viji, dynCall_viiiiiiiiiii, dynCall_iiif, dynCall_jiii, dynCall_iiiijj, dynCall_viiijjj, dynCall_fff, dynCall_viifii, dynCall_iff, dynCall_ijj, dynCall_fii, dynCall_vfiii, dynCall_jjj, dynCall_fiii, dynCall_viiiiiiiii, dynCall_viiiffii, dynCall_iiiiiffi, dynCall_viiiiiff, dynCall_viiiiiiiiiiiii, dynCall_viiiiiiiiiiii, dynCall_viiiiiiiiiiiiiiiii, dynCall_iifff, dynCall_iiff, dynCall_iiifiii, dynCall_iiffi, dynCall_iiffii, dynCall_viiiiiiiiiiiiii, dynCall_iif, dynCall_viijii, dynCall_iiiji, dynCall_viiif, dynCall_viiifiii, dynCall_fiif, dynCall_iiiifi, dynCall_iiiifiii, dynCall_iiifi, dynCall_viiiif, dynCall_viiiifii, dynCall_dii, dynCall_vifi, dynCall_vidi, dynCall_vijjj, dynCall_vj, dynCall_viij, dynCall_jiji, dynCall_iidiiiii, dynCall_iiiiij, dynCall_iiiiid, dynCall_iiiiijj, dynCall_iiiiiijj, _asyncify_start_unwind, _asyncify_stop_unwind, _asyncify_start_rewind, _asyncify_stop_rewind, memory, _kVersionStampBuildChangelistStr, _kVersionStampCitcSnapshotStr, _kVersionStampCitcWorkspaceIdStr, _kVersionStampSourceUriStr, _kVersionStampBuildClientStr, _kVersionStampBuildClientMintStatusStr, _kVersionStampBuildCompilerStr, _kVersionStampBuildDateTimePstStr, _kVersionStampBuildDepotPathStr, _kVersionStampBuildIdStr, _kVersionStampBuildInfoStr, _kVersionStampBuildLabelStr, _kVersionStampBuildTargetStr, _kVersionStampBuildTimestampStr, _kVersionStampBuildToolStr, _kVersionStampG3BuildTargetStr, _kVersionStampVerifiableStr, _kVersionStampBuildFdoTypeStr, _kVersionStampBuildBaselineChangelistStr, _kVersionStampBuildLtoTypeStr, _kVersionStampBuildPropellerTypeStr, _kVersionStampBuildPghoTypeStr, _kVersionStampBuildUsernameStr, _kVersionStampBuildHostnameStr, _kVersionStampBuildDirectoryStr, _kVersionStampBuildChangelistInt, _kVersionStampCitcSnapshotInt, _kVersionStampBuildClientMintStatusInt, _kVersionStampBuildTimestampInt, _kVersionStampVerifiableInt, _kVersionStampBuildCoverageEnabledInt, _kVersionStampBuildBaselineChangelistInt, _kVersionStampPrecookedTimestampStr, _kVersionStampPrecookedClientInfoStr, __indirect_function_table, _kVersionStampBuildHasHardeningProtobuf, wasmMemory;

function assignWasmExports(wasmExports) {
  _free = Module["_free"] = wasmExports["dd"];
  _CreateLlmInferenceEngineConverted = Module["_CreateLlmInferenceEngineConverted"] = wasmExports["ed"];
  _DeleteLlmInferenceEngine = Module["_DeleteLlmInferenceEngine"] = wasmExports["fd"];
  _MakeSessionForPredict = Module["_MakeSessionForPredict"] = wasmExports["gd"];
  _AddTextQueryChunk = Module["_AddTextQueryChunk"] = wasmExports["hd"];
  _AddImageQueryChunk = Module["_AddImageQueryChunk"] = wasmExports["id"];
  _AddAudioQueryChunk = Module["_AddAudioQueryChunk"] = wasmExports["jd"];
  _malloc = Module["_malloc"] = wasmExports["kd"];
  _PredictSession = Module["_PredictSession"] = wasmExports["ld"];
  _FreeSession = Module["_FreeSession"] = wasmExports["md"];
  _GetSizeInTokens = Module["_GetSizeInTokens"] = wasmExports["nd"];
  _wgpuDeviceAddRef = wasmExports["od"];
  _registerModelResourcesGraphService = Module["_registerModelResourcesGraphService"] = wasmExports["pd"];
  _bindTextureToStream = Module["_bindTextureToStream"] = wasmExports["qd"];
  _addBoundTextureToStream = Module["_addBoundTextureToStream"] = wasmExports["rd"];
  _addDoubleToInputStream = Module["_addDoubleToInputStream"] = wasmExports["sd"];
  _addFloatToInputStream = Module["_addFloatToInputStream"] = wasmExports["td"];
  _addBoolToInputStream = Module["_addBoolToInputStream"] = wasmExports["ud"];
  _addIntToInputStream = Module["_addIntToInputStream"] = wasmExports["vd"];
  _addUintToInputStream = Module["_addUintToInputStream"] = wasmExports["wd"];
  _addStringToInputStream = Module["_addStringToInputStream"] = wasmExports["xd"];
  _addRawDataSpanToInputStream = Module["_addRawDataSpanToInputStream"] = wasmExports["yd"];
  _allocateBoolVector = Module["_allocateBoolVector"] = wasmExports["zd"];
  _allocateFloatVector = Module["_allocateFloatVector"] = wasmExports["Ad"];
  _allocateDoubleVector = Module["_allocateDoubleVector"] = wasmExports["Bd"];
  _allocateIntVector = Module["_allocateIntVector"] = wasmExports["Cd"];
  _allocateUintVector = Module["_allocateUintVector"] = wasmExports["Dd"];
  _allocateStringVector = Module["_allocateStringVector"] = wasmExports["Ed"];
  _addBoolVectorEntry = Module["_addBoolVectorEntry"] = wasmExports["Fd"];
  _addFloatVectorEntry = Module["_addFloatVectorEntry"] = wasmExports["Gd"];
  _addDoubleVectorEntry = Module["_addDoubleVectorEntry"] = wasmExports["Hd"];
  _addIntVectorEntry = Module["_addIntVectorEntry"] = wasmExports["Id"];
  _addUintVectorEntry = Module["_addUintVectorEntry"] = wasmExports["Jd"];
  _addStringVectorEntry = Module["_addStringVectorEntry"] = wasmExports["Kd"];
  _addBoolVectorToInputStream = Module["_addBoolVectorToInputStream"] = wasmExports["Ld"];
  _addFloatVectorToInputStream = Module["_addFloatVectorToInputStream"] = wasmExports["Md"];
  _addDoubleVectorToInputStream = Module["_addDoubleVectorToInputStream"] = wasmExports["Nd"];
  _addIntVectorToInputStream = Module["_addIntVectorToInputStream"] = wasmExports["Od"];
  _addUintVectorToInputStream = Module["_addUintVectorToInputStream"] = wasmExports["Pd"];
  _addStringVectorToInputStream = Module["_addStringVectorToInputStream"] = wasmExports["Qd"];
  _addFlatHashMapToInputStream = Module["_addFlatHashMapToInputStream"] = wasmExports["Rd"];
  _addProtoToInputStream = Module["_addProtoToInputStream"] = wasmExports["Sd"];
  _addEmptyPacketToInputStream = Module["_addEmptyPacketToInputStream"] = wasmExports["Td"];
  _addBoolToInputSidePacket = Module["_addBoolToInputSidePacket"] = wasmExports["Ud"];
  _addDoubleToInputSidePacket = Module["_addDoubleToInputSidePacket"] = wasmExports["Vd"];
  _addFloatToInputSidePacket = Module["_addFloatToInputSidePacket"] = wasmExports["Wd"];
  _addIntToInputSidePacket = Module["_addIntToInputSidePacket"] = wasmExports["Xd"];
  _addUintToInputSidePacket = Module["_addUintToInputSidePacket"] = wasmExports["Yd"];
  _addStringToInputSidePacket = Module["_addStringToInputSidePacket"] = wasmExports["Zd"];
  _addRawDataSpanToInputSidePacket = Module["_addRawDataSpanToInputSidePacket"] = wasmExports["_d"];
  _addProtoToInputSidePacket = Module["_addProtoToInputSidePacket"] = wasmExports["$d"];
  _addBoolVectorToInputSidePacket = Module["_addBoolVectorToInputSidePacket"] = wasmExports["ae"];
  _addDoubleVectorToInputSidePacket = Module["_addDoubleVectorToInputSidePacket"] = wasmExports["be"];
  _addFloatVectorToInputSidePacket = Module["_addFloatVectorToInputSidePacket"] = wasmExports["ce"];
  _addIntVectorToInputSidePacket = Module["_addIntVectorToInputSidePacket"] = wasmExports["de"];
  _addUintVectorToInputSidePacket = Module["_addUintVectorToInputSidePacket"] = wasmExports["ee"];
  _addStringVectorToInputSidePacket = Module["_addStringVectorToInputSidePacket"] = wasmExports["fe"];
  _attachBoolListener = Module["_attachBoolListener"] = wasmExports["ge"];
  _attachBoolVectorListener = Module["_attachBoolVectorListener"] = wasmExports["he"];
  _attachDoubleListener = Module["_attachDoubleListener"] = wasmExports["ie"];
  _attachDoubleVectorListener = Module["_attachDoubleVectorListener"] = wasmExports["je"];
  _attachFloatListener = Module["_attachFloatListener"] = wasmExports["ke"];
  _attachFloatVectorListener = Module["_attachFloatVectorListener"] = wasmExports["le"];
  _attachIntListener = Module["_attachIntListener"] = wasmExports["me"];
  _attachIntVectorListener = Module["_attachIntVectorListener"] = wasmExports["ne"];
  _attachUintListener = Module["_attachUintListener"] = wasmExports["oe"];
  _attachUintVectorListener = Module["_attachUintVectorListener"] = wasmExports["pe"];
  _attachStringListener = Module["_attachStringListener"] = wasmExports["qe"];
  _attachStringVectorListener = Module["_attachStringVectorListener"] = wasmExports["re"];
  _attachProtoListener = Module["_attachProtoListener"] = wasmExports["se"];
  _attachProtoVectorListener = Module["_attachProtoVectorListener"] = wasmExports["te"];
  _getGraphConfig = Module["_getGraphConfig"] = wasmExports["ue"];
  ___getTypeName = wasmExports["ve"];
  _emwgpuCreateBindGroup = wasmExports["we"];
  _emwgpuCreateBindGroupLayout = wasmExports["xe"];
  _emwgpuCreateCommandBuffer = wasmExports["ye"];
  _emwgpuCreateCommandEncoder = wasmExports["ze"];
  _emwgpuCreateComputePassEncoder = wasmExports["Ae"];
  _emwgpuCreateComputePipeline = wasmExports["Be"];
  _emwgpuCreateExternalTexture = wasmExports["Ce"];
  _emwgpuCreatePipelineLayout = wasmExports["De"];
  _emwgpuCreateQuerySet = wasmExports["Ee"];
  _emwgpuCreateRenderBundle = wasmExports["Fe"];
  _emwgpuCreateRenderBundleEncoder = wasmExports["Ge"];
  _emwgpuCreateRenderPassEncoder = wasmExports["He"];
  _emwgpuCreateRenderPipeline = wasmExports["Ie"];
  _emwgpuCreateSampler = wasmExports["Je"];
  _emwgpuCreateSurface = wasmExports["Ke"];
  _emwgpuCreateTexture = wasmExports["Le"];
  _emwgpuCreateTextureView = wasmExports["Me"];
  _emwgpuCreateAdapter = wasmExports["Ne"];
  _emwgpuImportBuffer = wasmExports["Oe"];
  _emwgpuCreateDevice = wasmExports["Pe"];
  _emwgpuCreateQueue = wasmExports["Qe"];
  _emwgpuCreateShaderModule = wasmExports["Re"];
  _emwgpuOnCreateComputePipelineCompleted = wasmExports["Se"];
  _emwgpuOnWorkDoneCompleted = wasmExports["Te"];
  _clearSubgraphs = Module["_clearSubgraphs"] = wasmExports["Ue"];
  _pushBinarySubgraph = Module["_pushBinarySubgraph"] = wasmExports["Ve"];
  _pushTextSubgraph = Module["_pushTextSubgraph"] = wasmExports["We"];
  _changeBinaryGraph = Module["_changeBinaryGraph"] = wasmExports["Xe"];
  _changeTextGraph = Module["_changeTextGraph"] = wasmExports["Ye"];
  _processGl = Module["_processGl"] = wasmExports["Ze"];
  _process = Module["_process"] = wasmExports["_e"];
  _bindTextureToCanvas = Module["_bindTextureToCanvas"] = wasmExports["$e"];
  _requestShaderRefreshOnGraphChange = Module["_requestShaderRefreshOnGraphChange"] = wasmExports["af"];
  _waitUntilIdle = Module["_waitUntilIdle"] = wasmExports["bf"];
  _closeGraph = Module["_closeGraph"] = wasmExports["cf"];
  _setAutoRenderToScreen = Module["_setAutoRenderToScreen"] = wasmExports["df"];
  _emscripten_builtin_memalign = wasmExports["ff"];
  _memalign = wasmExports["gf"];
  __emscripten_tempret_set = wasmExports["hf"];
  __emscripten_stack_restore = wasmExports["jf"];
  __emscripten_stack_alloc = wasmExports["kf"];
  _emscripten_stack_get_current = wasmExports["lf"];
  dynCall_vii = dynCalls["vii"] = wasmExports["mf"];
  dynCall_viiiiiii = dynCalls["viiiiiii"] = wasmExports["nf"];
  dynCall_viiiiii = dynCalls["viiiiii"] = wasmExports["of"];
  dynCall_v = dynCalls["v"] = wasmExports["pf"];
  dynCall_ii = dynCalls["ii"] = wasmExports["qf"];
  dynCall_vi = dynCalls["vi"] = wasmExports["rf"];
  dynCall_iiiii = dynCalls["iiiii"] = wasmExports["sf"];
  dynCall_iii = dynCalls["iii"] = wasmExports["tf"];
  dynCall_viii = dynCalls["viii"] = wasmExports["uf"];
  dynCall_iiii = dynCalls["iiii"] = wasmExports["vf"];
  dynCall_iiiijij = dynCalls["iiiijij"] = wasmExports["wf"];
  dynCall_i = dynCalls["i"] = wasmExports["xf"];
  dynCall_ji = dynCalls["ji"] = wasmExports["yf"];
  dynCall_viiii = dynCalls["viiii"] = wasmExports["zf"];
  dynCall_viiiii = dynCalls["viiiii"] = wasmExports["Af"];
  dynCall_jii = dynCalls["jii"] = wasmExports["Bf"];
  dynCall_ff = dynCalls["ff"] = wasmExports["Cf"];
  dynCall_did = dynCalls["did"] = wasmExports["Df"];
  dynCall_iiiiiii = dynCalls["iiiiiii"] = wasmExports["Ef"];
  dynCall_iiiiii = dynCalls["iiiiii"] = wasmExports["Ff"];
  dynCall_iiiiiiiiiii = dynCalls["iiiiiiiiiii"] = wasmExports["Gf"];
  dynCall_iiiiiiiiiiii = dynCalls["iiiiiiiiiiii"] = wasmExports["Hf"];
  dynCall_iiiiiiiii = dynCalls["iiiiiiiii"] = wasmExports["If"];
  dynCall_iiiiiiii = dynCalls["iiiiiiii"] = wasmExports["Jf"];
  dynCall_iiiiiiiiii = dynCalls["iiiiiiiiii"] = wasmExports["Kf"];
  dynCall_iij = dynCalls["iij"] = wasmExports["Lf"];
  dynCall_viijj = dynCalls["viijj"] = wasmExports["Mf"];
  dynCall_vijiii = dynCalls["vijiii"] = wasmExports["Nf"];
  dynCall_viiiiiiii = dynCalls["viiiiiiii"] = wasmExports["Of"];
  dynCall_iiiif = dynCalls["iiiif"] = wasmExports["Pf"];
  dynCall_viiiiiiiiiiiiiii = dynCalls["viiiiiiiiiiiiiii"] = wasmExports["Qf"];
  dynCall_viff = dynCalls["viff"] = wasmExports["Rf"];
  dynCall_viiffii = dynCalls["viiffii"] = wasmExports["Sf"];
  dynCall_viiffi = dynCalls["viiffi"] = wasmExports["Tf"];
  dynCall_viiiiiiiiii = dynCalls["viiiiiiiiii"] = wasmExports["Uf"];
  dynCall_fi = dynCalls["fi"] = wasmExports["Vf"];
  dynCall_viiffff = dynCalls["viiffff"] = wasmExports["Wf"];
  dynCall_viiiiij = dynCalls["viiiiij"] = wasmExports["Xf"];
  dynCall_vij = dynCalls["vij"] = wasmExports["Yf"];
  dynCall_viiiiiffii = dynCalls["viiiiiffii"] = wasmExports["Zf"];
  dynCall_vif = dynCalls["vif"] = wasmExports["_f"];
  dynCall_ddd = dynCalls["ddd"] = wasmExports["$f"];
  dynCall_dddd = dynCalls["dddd"] = wasmExports["ag"];
  dynCall_idd = dynCalls["idd"] = wasmExports["bg"];
  dynCall_di = dynCalls["di"] = wasmExports["cg"];
  dynCall_jiiiijiiiii = dynCalls["jiiiijiiiii"] = wasmExports["dg"];
  dynCall_viiij = dynCalls["viiij"] = wasmExports["eg"];
  dynCall_viid = dynCalls["viid"] = wasmExports["fg"];
  dynCall_vidd = dynCalls["vidd"] = wasmExports["gg"];
  dynCall_vifd = dynCalls["vifd"] = wasmExports["hg"];
  dynCall_viji = dynCalls["viji"] = wasmExports["ig"];
  dynCall_viiiiiiiiiii = dynCalls["viiiiiiiiiii"] = wasmExports["jg"];
  dynCall_iiif = dynCalls["iiif"] = wasmExports["kg"];
  dynCall_jiii = dynCalls["jiii"] = wasmExports["lg"];
  dynCall_iiiijj = dynCalls["iiiijj"] = wasmExports["mg"];
  dynCall_viiijjj = dynCalls["viiijjj"] = wasmExports["ng"];
  dynCall_fff = dynCalls["fff"] = wasmExports["og"];
  dynCall_viifii = dynCalls["viifii"] = wasmExports["pg"];
  dynCall_iff = dynCalls["iff"] = wasmExports["qg"];
  dynCall_ijj = dynCalls["ijj"] = wasmExports["rg"];
  dynCall_fii = dynCalls["fii"] = wasmExports["sg"];
  dynCall_vfiii = dynCalls["vfiii"] = wasmExports["tg"];
  dynCall_jjj = dynCalls["jjj"] = wasmExports["ug"];
  dynCall_fiii = dynCalls["fiii"] = wasmExports["vg"];
  dynCall_viiiiiiiii = dynCalls["viiiiiiiii"] = wasmExports["wg"];
  dynCall_viiiffii = dynCalls["viiiffii"] = wasmExports["xg"];
  dynCall_iiiiiffi = dynCalls["iiiiiffi"] = wasmExports["yg"];
  dynCall_viiiiiff = dynCalls["viiiiiff"] = wasmExports["zg"];
  dynCall_viiiiiiiiiiiii = dynCalls["viiiiiiiiiiiii"] = wasmExports["Ag"];
  dynCall_viiiiiiiiiiii = dynCalls["viiiiiiiiiiii"] = wasmExports["Bg"];
  dynCall_viiiiiiiiiiiiiiiii = dynCalls["viiiiiiiiiiiiiiiii"] = wasmExports["Cg"];
  dynCall_iifff = dynCalls["iifff"] = wasmExports["Dg"];
  dynCall_iiff = dynCalls["iiff"] = wasmExports["Eg"];
  dynCall_iiifiii = dynCalls["iiifiii"] = wasmExports["Fg"];
  dynCall_iiffi = dynCalls["iiffi"] = wasmExports["Gg"];
  dynCall_iiffii = dynCalls["iiffii"] = wasmExports["Hg"];
  dynCall_viiiiiiiiiiiiii = dynCalls["viiiiiiiiiiiiii"] = wasmExports["Ig"];
  dynCall_iif = dynCalls["iif"] = wasmExports["Jg"];
  dynCall_viijii = dynCalls["viijii"] = wasmExports["Kg"];
  dynCall_iiiji = dynCalls["iiiji"] = wasmExports["Lg"];
  dynCall_viiif = dynCalls["viiif"] = wasmExports["Mg"];
  dynCall_viiifiii = dynCalls["viiifiii"] = wasmExports["Ng"];
  dynCall_fiif = dynCalls["fiif"] = wasmExports["Og"];
  dynCall_iiiifi = dynCalls["iiiifi"] = wasmExports["Pg"];
  dynCall_iiiifiii = dynCalls["iiiifiii"] = wasmExports["Qg"];
  dynCall_iiifi = dynCalls["iiifi"] = wasmExports["Rg"];
  dynCall_viiiif = dynCalls["viiiif"] = wasmExports["Sg"];
  dynCall_viiiifii = dynCalls["viiiifii"] = wasmExports["Tg"];
  dynCall_dii = dynCalls["dii"] = wasmExports["Ug"];
  dynCall_vifi = dynCalls["vifi"] = wasmExports["Vg"];
  dynCall_vidi = dynCalls["vidi"] = wasmExports["Wg"];
  dynCall_vijjj = dynCalls["vijjj"] = wasmExports["Xg"];
  dynCall_vj = dynCalls["vj"] = wasmExports["Yg"];
  dynCall_viij = dynCalls["viij"] = wasmExports["Zg"];
  dynCall_jiji = dynCalls["jiji"] = wasmExports["_g"];
  dynCall_iidiiiii = dynCalls["iidiiiii"] = wasmExports["$g"];
  dynCall_iiiiij = dynCalls["iiiiij"] = wasmExports["ah"];
  dynCall_iiiiid = dynCalls["iiiiid"] = wasmExports["bh"];
  dynCall_iiiiijj = dynCalls["iiiiijj"] = wasmExports["ch"];
  dynCall_iiiiiijj = dynCalls["iiiiiijj"] = wasmExports["dh"];
  _asyncify_start_unwind = wasmExports["eh"];
  _asyncify_stop_unwind = wasmExports["fh"];
  _asyncify_start_rewind = wasmExports["gh"];
  _asyncify_stop_rewind = wasmExports["hh"];
  ...
  _kVersionStampBuildUsernameStr = Module["_kVersionStampBuildUsernameStr"] = (wasmExports["Tc"].value) >>> 0;
  _kVersionStampBuildHostnameStr = Module["_kVersionStampBuildHostnameStr"] = (wasmExports["Uc"].value) >>> 0;
  _kVersionStampBuildDirectoryStr = Module["_kVersionStampBuildDirectoryStr"] = (wasmExports["Vc"].value) >>> 0;
  _kVersionStampBuildChangelistInt = Module["_kVersionStampBuildChangelistInt"] = (wasmExports["Wc"].value) >>> 0;
  _kVersionStampCitcSnapshotInt = Module["_kVersionStampCitcSnapshotInt"] = (wasmExports["Xc"].value) >>> 0;
  _kVersionStampBuildClientMintStatusInt = Module["_kVersionStampBuildClientMintStatusInt"] = (wasmExports["Yc"].value) >>> 0;
  _kVersionStampBuildTimestampInt = Module["_kVersionStampBuildTimestampInt"] = (wasmExports["Zc"].value) >>> 0;
  _kVersionStampVerifiableInt = Module["_kVersionStampVerifiableInt"] = (wasmExports["_c"].value) >>> 0;
  _kVersionStampBuildCoverageEnabledInt = Module["_kVersionStampBuildCoverageEnabledInt"] = (wasmExports["$c"].value) >>> 0;
  _kVersionStampBuildBaselineChangelistInt = Module["_kVersionStampBuildBaselineChangelistInt"] = (wasmExports["ad"].value) >>> 0;
  _kVersionStampPrecookedTimestampStr = Module["_kVersionStampPrecookedTimestampStr"] = (wasmExports["bd"].value) >>> 0;
  _kVersionStampPrecookedClientInfoStr = Module["_kVersionStampPrecookedClientInfoStr"] = (wasmExports["cd"].value) >>> 0;
  __indirect_function_table = wasmExports["__indirect_function_table"];
  _kVersionStampBuildHasHardeningProtobuf = Module["_kVersionStampBuildHasHardeningProtobuf"] = (wasmExports["ef"].value) >>> 0;
}
...
function applySignatureConversions(wasmExports) {
  ...
  wasmExports["kd"] = makeWrapper_pp(wasmExports["kd"]);
  wasmExports["ve"] = makeWrapper_pp(wasmExports["ve"]);
  wasmExports["ff"] = makeWrapper_ppp(wasmExports["ff"]);
  wasmExports["gf"] = makeWrapper_ppp(wasmExports["gf"]);
  wasmExports["kf"] = makeWrapper_pp(wasmExports["kf"]);
  wasmExports["lf"] = makeWrapper_p(wasmExports["lf"]);
  return wasmExports;
}
