...
var ASM_CONSTS = {
  2084812: () => !!Module["preinitializedWebGPUDevice"],
  2084863: () => {
  ...
  2085046: () => !!Module["preinitializedWebGPUDevice"],
  2085097: () => {
...
function assignWasmExports(wasmExports) {
  _free = Module["_free"] = wasmExports["ed"];
  _CreateLlmInferenceEngineConverted = Module["_CreateLlmInferenceEngineConverted"] = wasmExports["fd"];
  _DeleteLlmInferenceEngine = Module["_DeleteLlmInferenceEngine"] = wasmExports["gd"];
  _MakeSessionForPredict = Module["_MakeSessionForPredict"] = wasmExports["hd"];
  _AddTextQueryChunk = Module["_AddTextQueryChunk"] = wasmExports["id"];
  _AddImageQueryChunk = Module["_AddImageQueryChunk"] = wasmExports["jd"];
  _AddAudioQueryChunk = Module["_AddAudioQueryChunk"] = wasmExports["kd"];
  _malloc = Module["_malloc"] = wasmExports["ld"];
  _PredictSession = Module["_PredictSession"] = wasmExports["md"];
  _FreeSession = Module["_FreeSession"] = wasmExports["nd"];
  _GetSizeInTokens = Module["_GetSizeInTokens"] = wasmExports["od"];
  _wgpuDeviceAddRef = wasmExports["pd"];
  _registerModelResourcesGraphService = Module["_registerModelResourcesGraphService"] = wasmExports["qd"];
  _bindTextureToStream = Module["_bindTextureToStream"] = wasmExports["rd"];
  _addBoundTextureToStream = Module["_addBoundTextureToStream"] = wasmExports["sd"];
  _addDoubleToInputStream = Module["_addDoubleToInputStream"] = wasmExports["td"];
  _addFloatToInputStream = Module["_addFloatToInputStream"] = wasmExports["ud"];
  _addBoolToInputStream = Module["_addBoolToInputStream"] = wasmExports["vd"];
  _addIntToInputStream = Module["_addIntToInputStream"] = wasmExports["wd"];
  _addUintToInputStream = Module["_addUintToInputStream"] = wasmExports["xd"];
  _addStringToInputStream = Module["_addStringToInputStream"] = wasmExports["yd"];
  _addRawDataSpanToInputStream = Module["_addRawDataSpanToInputStream"] = wasmExports["zd"];
  _allocateBoolVector = Module["_allocateBoolVector"] = wasmExports["Ad"];
  _allocateFloatVector = Module["_allocateFloatVector"] = wasmExports["Bd"];
  _allocateDoubleVector = Module["_allocateDoubleVector"] = wasmExports["Cd"];
  _allocateIntVector = Module["_allocateIntVector"] = wasmExports["Dd"];
  _allocateUintVector = Module["_allocateUintVector"] = wasmExports["Ed"];
  _allocateStringVector = Module["_allocateStringVector"] = wasmExports["Fd"];
  _addBoolVectorEntry = Module["_addBoolVectorEntry"] = wasmExports["Gd"];
  _addFloatVectorEntry = Module["_addFloatVectorEntry"] = wasmExports["Hd"];
  _addDoubleVectorEntry = Module["_addDoubleVectorEntry"] = wasmExports["Id"];
  _addIntVectorEntry = Module["_addIntVectorEntry"] = wasmExports["Jd"];
  _addUintVectorEntry = Module["_addUintVectorEntry"] = wasmExports["Kd"];
  _addStringVectorEntry = Module["_addStringVectorEntry"] = wasmExports["Ld"];
  _addBoolVectorToInputStream = Module["_addBoolVectorToInputStream"] = wasmExports["Md"];
  _addFloatVectorToInputStream = Module["_addFloatVectorToInputStream"] = wasmExports["Nd"];
  _addDoubleVectorToInputStream = Module["_addDoubleVectorToInputStream"] = wasmExports["Od"];
  _addIntVectorToInputStream = Module["_addIntVectorToInputStream"] = wasmExports["Pd"];
  _addUintVectorToInputStream = Module["_addUintVectorToInputStream"] = wasmExports["Qd"];
  _addStringVectorToInputStream = Module["_addStringVectorToInputStream"] = wasmExports["Rd"];
  _addFlatHashMapToInputStream = Module["_addFlatHashMapToInputStream"] = wasmExports["Sd"];
  _addProtoToInputStream = Module["_addProtoToInputStream"] = wasmExports["Td"];
  _addEmptyPacketToInputStream = Module["_addEmptyPacketToInputStream"] = wasmExports["Ud"];
  _addBoolToInputSidePacket = Module["_addBoolToInputSidePacket"] = wasmExports["Vd"];
  _addDoubleToInputSidePacket = Module["_addDoubleToInputSidePacket"] = wasmExports["Wd"];
  _addFloatToInputSidePacket = Module["_addFloatToInputSidePacket"] = wasmExports["Xd"];
  _addIntToInputSidePacket = Module["_addIntToInputSidePacket"] = wasmExports["Yd"];
  _addUintToInputSidePacket = Module["_addUintToInputSidePacket"] = wasmExports["Zd"];
  _addStringToInputSidePacket = Module["_addStringToInputSidePacket"] = wasmExports["_d"];
  _addRawDataSpanToInputSidePacket = Module["_addRawDataSpanToInputSidePacket"] = wasmExports["$d"];
  _addProtoToInputSidePacket = Module["_addProtoToInputSidePacket"] = wasmExports["ae"];
  _addBoolVectorToInputSidePacket = Module["_addBoolVectorToInputSidePacket"] = wasmExports["be"];
  _addDoubleVectorToInputSidePacket = Module["_addDoubleVectorToInputSidePacket"] = wasmExports["ce"];
  _addFloatVectorToInputSidePacket = Module["_addFloatVectorToInputSidePacket"] = wasmExports["de"];
  _addIntVectorToInputSidePacket = Module["_addIntVectorToInputSidePacket"] = wasmExports["ee"];
  _addUintVectorToInputSidePacket = Module["_addUintVectorToInputSidePacket"] = wasmExports["fe"];
  _addStringVectorToInputSidePacket = Module["_addStringVectorToInputSidePacket"] = wasmExports["ge"];
  _attachBoolListener = Module["_attachBoolListener"] = wasmExports["he"];
  _attachBoolVectorListener = Module["_attachBoolVectorListener"] = wasmExports["ie"];
  _attachDoubleListener = Module["_attachDoubleListener"] = wasmExports["je"];
  _attachDoubleVectorListener = Module["_attachDoubleVectorListener"] = wasmExports["ke"];
  _attachFloatListener = Module["_attachFloatListener"] = wasmExports["le"];
  _attachFloatVectorListener = Module["_attachFloatVectorListener"] = wasmExports["me"];
  _attachIntListener = Module["_attachIntListener"] = wasmExports["ne"];
  _attachIntVectorListener = Module["_attachIntVectorListener"] = wasmExports["oe"];
  _attachUintListener = Module["_attachUintListener"] = wasmExports["pe"];
  _attachUintVectorListener = Module["_attachUintVectorListener"] = wasmExports["qe"];
  _attachStringListener = Module["_attachStringListener"] = wasmExports["re"];
  _attachStringVectorListener = Module["_attachStringVectorListener"] = wasmExports["se"];
  _attachProtoListener = Module["_attachProtoListener"] = wasmExports["te"];
  _attachProtoVectorListener = Module["_attachProtoVectorListener"] = wasmExports["ue"];
  _getGraphConfig = Module["_getGraphConfig"] = wasmExports["ve"];
  ___getTypeName = wasmExports["we"];
  _emwgpuCreateBindGroup = wasmExports["xe"];
  _emwgpuCreateBindGroupLayout = wasmExports["ye"];
  _emwgpuCreateCommandBuffer = wasmExports["ze"];
  _emwgpuCreateCommandEncoder = wasmExports["Ae"];
  _emwgpuCreateComputePassEncoder = wasmExports["Be"];
  _emwgpuCreateComputePipeline = wasmExports["Ce"];
  _emwgpuCreateExternalTexture = wasmExports["De"];
  _emwgpuCreatePipelineLayout = wasmExports["Ee"];
  _emwgpuCreateQuerySet = wasmExports["Fe"];
  _emwgpuCreateRenderBundle = wasmExports["Ge"];
  _emwgpuCreateRenderBundleEncoder = wasmExports["He"];
  _emwgpuCreateRenderPassEncoder = wasmExports["Ie"];
  _emwgpuCreateRenderPipeline = wasmExports["Je"];
  _emwgpuCreateSampler = wasmExports["Ke"];
  _emwgpuCreateSurface = wasmExports["Le"];
  _emwgpuCreateTexture = wasmExports["Me"];
  _emwgpuCreateTextureView = wasmExports["Ne"];
  _emwgpuCreateAdapter = wasmExports["Oe"];
  _emwgpuImportBuffer = wasmExports["Pe"];
  _emwgpuCreateDevice = wasmExports["Qe"];
  _emwgpuCreateQueue = wasmExports["Re"];
  _emwgpuCreateShaderModule = wasmExports["Se"];
  _emwgpuOnCreateComputePipelineCompleted = wasmExports["Te"];
  _emwgpuOnWorkDoneCompleted = wasmExports["Ue"];
  _clearSubgraphs = Module["_clearSubgraphs"] = wasmExports["Ve"];
  _pushBinarySubgraph = Module["_pushBinarySubgraph"] = wasmExports["We"];
  _pushTextSubgraph = Module["_pushTextSubgraph"] = wasmExports["Xe"];
  _changeBinaryGraph = Module["_changeBinaryGraph"] = wasmExports["Ye"];
  _changeTextGraph = Module["_changeTextGraph"] = wasmExports["Ze"];
  _processGl = Module["_processGl"] = wasmExports["_e"];
  _process = Module["_process"] = wasmExports["$e"];
  _bindTextureToCanvas = Module["_bindTextureToCanvas"] = wasmExports["af"];
  _requestShaderRefreshOnGraphChange = Module["_requestShaderRefreshOnGraphChange"] = wasmExports["bf"];
  _waitUntilIdle = Module["_waitUntilIdle"] = wasmExports["cf"];
  _closeGraph = Module["_closeGraph"] = wasmExports["df"];
  _setAutoRenderToScreen = Module["_setAutoRenderToScreen"] = wasmExports["ef"];
  _emscripten_builtin_memalign = wasmExports["gf"];
  _memalign = wasmExports["hf"];
  __emscripten_tempret_set = wasmExports["jf"];
  __emscripten_stack_restore = wasmExports["kf"];
  __emscripten_stack_alloc = wasmExports["lf"];
  _emscripten_stack_get_current = wasmExports["mf"];
  dynCall_vii = dynCalls["vii"] = wasmExports["nf"];
  dynCall_viiiiiii = dynCalls["viiiiiii"] = wasmExports["of"];
  dynCall_viiiiii = dynCalls["viiiiii"] = wasmExports["pf"];
  dynCall_v = dynCalls["v"] = wasmExports["qf"];
  dynCall_ii = dynCalls["ii"] = wasmExports["rf"];
  dynCall_vi = dynCalls["vi"] = wasmExports["sf"];
  dynCall_iiiii = dynCalls["iiiii"] = wasmExports["tf"];
  dynCall_iii = dynCalls["iii"] = wasmExports["uf"];
  dynCall_viii = dynCalls["viii"] = wasmExports["vf"];
  dynCall_iiii = dynCalls["iiii"] = wasmExports["wf"];
  dynCall_iiiijij = dynCalls["iiiijij"] = wasmExports["xf"];
  dynCall_i = dynCalls["i"] = wasmExports["yf"];
  dynCall_ji = dynCalls["ji"] = wasmExports["zf"];
  dynCall_viiii = dynCalls["viiii"] = wasmExports["Af"];
  dynCall_viiiii = dynCalls["viiiii"] = wasmExports["Bf"];
  dynCall_jii = dynCalls["jii"] = wasmExports["Cf"];
  dynCall_ff = dynCalls["ff"] = wasmExports["Df"];
  dynCall_did = dynCalls["did"] = wasmExports["Ef"];
  dynCall_iiiiiii = dynCalls["iiiiiii"] = wasmExports["Ff"];
  dynCall_iiiiii = dynCalls["iiiiii"] = wasmExports["Gf"];
  dynCall_iiiiiiiiiii = dynCalls["iiiiiiiiiii"] = wasmExports["Hf"];
  dynCall_iiiiiiiiiiii = dynCalls["iiiiiiiiiiii"] = wasmExports["If"];
  dynCall_iiiiiiiii = dynCalls["iiiiiiiii"] = wasmExports["Jf"];
  dynCall_iiiiiiii = dynCalls["iiiiiiii"] = wasmExports["Kf"];
  dynCall_iiiiiiiiii = dynCalls["iiiiiiiiii"] = wasmExports["Lf"];
  dynCall_iij = dynCalls["iij"] = wasmExports["Mf"];
  ...
  dynCall_iiiijj = dynCalls["iiiijj"] = wasmExports["ng"];
  dynCall_viiijjj = dynCalls["viiijjj"] = wasmExports["og"];
  dynCall_fff = dynCalls["fff"] = wasmExports["pg"];
  dynCall_viifii = dynCalls["viifii"] = wasmExports["qg"];
  dynCall_iff = dynCalls["iff"] = wasmExports["rg"];
  dynCall_ijj = dynCalls["ijj"] = wasmExports["sg"];
  dynCall_fii = dynCalls["fii"] = wasmExports["tg"];
  dynCall_vfiii = dynCalls["vfiii"] = wasmExports["ug"];
  dynCall_jjj = dynCalls["jjj"] = wasmExports["vg"];
  dynCall_fiii = dynCalls["fiii"] = wasmExports["wg"];
  dynCall_viiiiiiiii = dynCalls["viiiiiiiii"] = wasmExports["xg"];
  dynCall_viiiffii = dynCalls["viiiffii"] = wasmExports["yg"];
  dynCall_iiiiiffi = dynCalls["iiiiiffi"] = wasmExports["zg"];
  dynCall_viiiiiff = dynCalls["viiiiiff"] = wasmExports["Ag"];
  dynCall_viiiiiiiiiiiii = dynCalls["viiiiiiiiiiiii"] = wasmExports["Bg"];
  dynCall_viiiiiiiiiiii = dynCalls["viiiiiiiiiiii"] = wasmExports["Cg"];
  dynCall_viiiiiiiiiiiiiiiii = dynCalls["viiiiiiiiiiiiiiiii"] = wasmExports["Dg"];
  dynCall_iifff = dynCalls["iifff"] = wasmExports["Eg"];
  dynCall_iiff = dynCalls["iiff"] = wasmExports["Fg"];
  dynCall_iiifiii = dynCalls["iiifiii"] = wasmExports["Gg"];
  dynCall_iiffi = dynCalls["iiffi"] = wasmExports["Hg"];
  dynCall_iiffii = dynCalls["iiffii"] = wasmExports["Ig"];
  dynCall_viiiiiiiiiiiiii = dynCalls["viiiiiiiiiiiiii"] = wasmExports["Jg"];
  dynCall_iif = dynCalls["iif"] = wasmExports["Kg"];
  dynCall_viijii = dynCalls["viijii"] = wasmExports["Lg"];
  dynCall_iiiji = dynCalls["iiiji"] = wasmExports["Mg"];
  dynCall_viiif = dynCalls["viiif"] = wasmExports["Ng"];
  dynCall_viiifiii = dynCalls["viiifiii"] = wasmExports["Og"];
  dynCall_fiif = dynCalls["fiif"] = wasmExports["Pg"];
  dynCall_iiiifi = dynCalls["iiiifi"] = wasmExports["Qg"];
  dynCall_iiiifiii = dynCalls["iiiifiii"] = wasmExports["Rg"];
  dynCall_iiifi = dynCalls["iiifi"] = wasmExports["Sg"];
  dynCall_viiiif = dynCalls["viiiif"] = wasmExports["Tg"];
  dynCall_viiiifii = dynCalls["viiiifii"] = wasmExports["Ug"];
  dynCall_dii = dynCalls["dii"] = wasmExports["Vg"];
  dynCall_vifi = dynCalls["vifi"] = wasmExports["Wg"];
  dynCall_vidi = dynCalls["vidi"] = wasmExports["Xg"];
  dynCall_vijjj = dynCalls["vijjj"] = wasmExports["Yg"];
  dynCall_vj = dynCalls["vj"] = wasmExports["Zg"];
  dynCall_viij = dynCalls["viij"] = wasmExports["_g"];
  dynCall_jiji = dynCalls["jiji"] = wasmExports["$g"];
  dynCall_iidiiiii = dynCalls["iidiiiii"] = wasmExports["ah"];
  dynCall_iiiiij = dynCalls["iiiiij"] = wasmExports["bh"];
  dynCall_iiiiid = dynCalls["iiiiid"] = wasmExports["ch"];
  dynCall_iiiiijj = dynCalls["iiiiijj"] = wasmExports["dh"];
  dynCall_iiiiiijj = dynCalls["iiiiiijj"] = wasmExports["eh"];
  _asyncify_start_unwind = wasmExports["fh"];
  _asyncify_stop_unwind = wasmExports["gh"];
  _asyncify_start_rewind = wasmExports["hh"];
  _asyncify_stop_rewind = wasmExports["ih"];
  ...
  _kVersionStampBuildUsernameStr = Module["_kVersionStampBuildUsernameStr"] = (wasmExports["Uc"].value) >>> 0;
  _kVersionStampBuildHostnameStr = Module["_kVersionStampBuildHostnameStr"] = (wasmExports["Vc"].value) >>> 0;
  _kVersionStampBuildDirectoryStr = Module["_kVersionStampBuildDirectoryStr"] = (wasmExports["Wc"].value) >>> 0;
  _kVersionStampBuildChangelistInt = Module["_kVersionStampBuildChangelistInt"] = (wasmExports["Xc"].value) >>> 0;
  _kVersionStampCitcSnapshotInt = Module["_kVersionStampCitcSnapshotInt"] = (wasmExports["Yc"].value) >>> 0;
  _kVersionStampBuildClientMintStatusInt = Module["_kVersionStampBuildClientMintStatusInt"] = (wasmExports["Zc"].value) >>> 0;
  _kVersionStampBuildTimestampInt = Module["_kVersionStampBuildTimestampInt"] = (wasmExports["_c"].value) >>> 0;
  _kVersionStampVerifiableInt = Module["_kVersionStampVerifiableInt"] = (wasmExports["$c"].value) >>> 0;
  _kVersionStampBuildCoverageEnabledInt = Module["_kVersionStampBuildCoverageEnabledInt"] = (wasmExports["ad"].value) >>> 0;
  _kVersionStampBuildBaselineChangelistInt = Module["_kVersionStampBuildBaselineChangelistInt"] = (wasmExports["bd"].value) >>> 0;
  _kVersionStampPrecookedTimestampStr = Module["_kVersionStampPrecookedTimestampStr"] = (wasmExports["cd"].value) >>> 0;
  _kVersionStampPrecookedClientInfoStr = Module["_kVersionStampPrecookedClientInfoStr"] = (wasmExports["dd"].value) >>> 0;
  __indirect_function_table = wasmExports["__indirect_function_table"];
  _kVersionStampBuildHasHardeningProtobuf = Module["_kVersionStampBuildHasHardeningProtobuf"] = (wasmExports["ff"].value) >>> 0;
}
...
function applySignatureConversions(wasmExports) {
  ...
  wasmExports["ld"] = makeWrapper_pp(wasmExports["ld"]);
  wasmExports["we"] = makeWrapper_pp(wasmExports["we"]);
  wasmExports["gf"] = makeWrapper_ppp(wasmExports["gf"]);
  wasmExports["hf"] = makeWrapper_ppp(wasmExports["hf"]);
  wasmExports["lf"] = makeWrapper_pp(wasmExports["lf"]);
  wasmExports["mf"] = makeWrapper_p(wasmExports["mf"]);
  return wasmExports;
}
